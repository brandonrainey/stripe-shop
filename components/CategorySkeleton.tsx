...
export default function ProductsSkeleton({ category }: SkeletonProps) {
  return (
    <div>
        <h1 className="text-3xl font-bold pl-6 pt-6">{category}</h1>
        ...
        .map((_, index) => (
          <article className="flex justify-center animate-pulse" key={index}>
            <div className="flex flex-col  w-full h-96 gap-1  pb-1 mt-8 rounded-xl self-center justify-end ">
              <div className="w-full h-full flex justify-center bg-slate-200 rounded-lg">
