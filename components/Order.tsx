...
export default function Order({ order }: OrderProp) {
  ...
  return (
    <div className=" flex flex-col w-11/12 sm:w-3/4 h-62 border shadow-lg rounded-lg">
      ...
      <ScrollContainer
        className="flex p-2 px-4 gap-8 sm:h-44 h-32 items-center overflow-x-scroll scrollbar-thin scrollbar-thumb-blue-600 scrollbar-track-blue-300 scrollbar-thumb-rounded-full scrollbar-track-rounded-full"
