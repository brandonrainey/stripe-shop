...
import BannerImage from '../public/banner-small.webp'

export default function HeroBanner() {
  const router = useRouter()
  return (
    <div className="w-full h-[300px] sm:h-[700px] relative overflow-hidden">
      <h1 className="absolute w-[250px] lg:w-[600px] z-30 text-3xl md:text-4xl lg:text-5xl xl:text-6xl top-4 lg:top-32 xl:top-48 md:top-24 lg:-right-20 xl:right-20 md:right-0 -right-0 font-semibold text-slate-800 drop-shadow-lg">
